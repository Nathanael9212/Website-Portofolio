    ...
    >
      ...
      >
        ...
        <div style={{ padding: 'clamp(16px, 4vw, 32px)' }}>
          ...
          <p className="lead" style={{ marginBottom: '16px', fontSize: 'clamp(14px, 2vw, 18px)' }}>
            {project.description}
          </p>

          <div className="projTags" style={{ marginBottom: '24px' }}>
          ...
          <section className="contentSection" style={{ marginBottom: '16px' }}>
            ...
            <h3 style={{ fontSize: 'clamp(16px, 2.5vw, 20px)', marginTop: '20px', marginBottom: '10px', color: 'var(--text)', fontWeight: 700 }}>
              Fitur Kunci
            </h3>
            <ul style={{ listStyle: 'none', paddingLeft: 0 }}>
              <li style={{ marginBottom: '10px', paddingLeft: '20px', position: 'relative', color: 'var(--muted)', fontSize: '14px', lineHeight: '1.7' }}>
          ...
          <section className="contentSection">
            ...
            <div className="techGrid" style={{ marginTop: '16px' }}>
              <div className="techItem">
                <h3>Backend</h3>
                <p style={{ color: 'var(--muted)', margin: 0, fontSize: '14px' }}>Laravel 10 (PHP 8.2) - Eloquent ORM & Security Features</p>
              </div>
              <div className="techItem">
                <h3>Database</h3>
                <p style={{ color: 'var(--muted)', margin: 0, fontSize: '14px' }}>MySQL - Relational Database Design</p>
              </div>
              <div className="techItem">
                <h3>Frontend</h3>
                <p style={{ color: 'var(--muted)', margin: 0, fontSize: '14px' }}>Blade Templating + Tailwind CSS</p>
              </div>
            </div>
          </section>
          ...
          <div style={{
            ...
            <a
              href={project.githubUrl || `https://github.com/Nathanael9212/${project.slug}`}
              target="_blank"
              rel="noreferrer"
